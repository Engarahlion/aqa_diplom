...
public class AuthorizationTest {
    ...
    @Test
    public void visiblElementsAuthScreen() {
    ...
    @Description("Авторизация с пустым полем логина TC-5")
    @Test
    ...
    @Description("Авторизация с пустым полем пароля TC-6")
    @Test
    ...
    @Description("Авторизация с пустыми полями логина и пароля TC-7")
    @Test
